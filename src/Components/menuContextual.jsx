...
import { LogoutOutlined, InfoOutlined, CodeOutlined, Menu as MenuIcon } from '@mui/icons-material'
import About from './about'
import ConfigureIframe from './configureIframe'

export default function MenuContextual({ about, headerIframe, buttonText }) {
